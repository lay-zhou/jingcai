    ...
    <div class="body">
        <ul>
            <li v-for="jfxxList in jfxxLists" :key="jfxxList.id">
                <div class="left"></div>
                <div class="right">
                    <p class="type">{{ jfxxList.type }} {{ jfxxList.jf }}元</p>
   ...
   data() {
    return {
        jfxxLists: [
            ...
            { id:1 ,type: '充值', time: '2018/12/9  16:36:10', jf: 100000 },
            { id:2 ,type: '充值', time: '2018/12/9  16:36:10', jf: 10 },
            { id:3 ,type: '充值', time: '2018/12/9  16:36:10', jf: 20 },
            { id:4 ,type: '充值', time: '2018/12/9  16:36:10', jf: 10 },
            { id:5 ,type: '充值', time: '2018/12/9  16:36:10', jf: 40 }
        ]
    }
    }
}
