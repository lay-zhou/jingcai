...
<div class="sz">
    ...
    <div class="mid">
        <button class="zx" @click="zx">最小</button>
        ...
        <button class="zd" @click="zd">最大</button>
    </div>
    ...
    <div class="bottom">
        ...
        <ul class="box">
            <li v-for="(list,i) in lists" :key='i' @click="submit(list)"  :class="{ active:i==ins }" >  
                ...
                <transition @before-enter="beforeEnter" @enter="enter" @after-enter="afterEnter" >
                    <div v-show="shakecenter" :class="[{ showit:i==id},{none:(i-10) },{openCard:i==id}]">
                        <img :src="list.imgUrl" class="img1">
                        <span  class="img2" ></span>
                    </div>
                </transition>
        ...
        <div class="result" v-show="result">
            ...
            <div class="resultcard">
                ...
                <div class="card">
                    <router-link class="win" to="/"></router-link>
                </div>
            </div>
        </div>
    ...
    <div class="echart">
        <p>找规律</p>
        <echart class="chart2" :width="width" :height="height" :scaleData="scaleData" :type="type"></echart>
    </div>
